...
// Servo adjustment
#define _DUTY_MAX 2221  // Servo angle: D degree
#define _DUTY_NEU 1560  // Servo angle: 0 degree
#define _DUTY_MIN 899   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (437+(-1.19*a_value) + ((8.05*0.0001) * a_value * a_value));
}
