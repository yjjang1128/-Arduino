...
void loop()
{
  ...
  Serial.print("MIN:");     Serial.print(DIST_MIN); // print minimum distance
  Serial.print(",IR:");     Serial.print(a_value); // print IR sensor value
  Serial.print(",dist:");   Serial.print(dist); // print distance
  Serial.print(",ema:");    Serial.print(dist_ema); // print EMA distance
  Serial.print(",servo:");  Serial.print(duty); // print servo duty
  Serial.print(",MAX:");    Serial.print(DIST_MAX); // print maximum distance
